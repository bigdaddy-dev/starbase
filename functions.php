...
function starbase_numeric_posts_nav() {
...
function pagination($pages = '', $range = 4)
{
     ...
     if(1 != $pages)
     {
         echo "<div class=\"project-pagination\"><div>Page ".$paged." of ".$pages."</div>";
         ...
         for ($i=1; $i <= $pages; $i++)
         {
             ...
             {
                 echo ($paged == $i)? "<div class=\"current\">".$i."</div>":"<a href='".get_pagenum_link($i)."' class=\"inactive\">".$i."</a>";
             }
         }
